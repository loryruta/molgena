...
def get_mol(smiles):
    ...
    if mol is not None:
        # clearAromaticFlags: after kekulization all bonds in the molecule are marked as non-aromatic
        # Resolve: e.g. Can't kekulize mol. Unkekulized atoms: 5 6 7 8 9 10 18 26 27
...
def get_inter_label(mol, atoms, inter_atoms):
    """ Given the molecule and atom indices """
